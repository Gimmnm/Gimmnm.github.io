...
Push to `main` on the `Gimmnm/Gimmnm.github.io` repository. GitHub Actions builds and publishes automatically.

### First-time GitHub setup

1. Create a new repository named **`Gimmnm.github.io`** on GitHub (must match your username).
2. Push this folder:

```bash
git remote add origin git@github.com:Gimmnm/Gimmnm.github.io.git
git add .
