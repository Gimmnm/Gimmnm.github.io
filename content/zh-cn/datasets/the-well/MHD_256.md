...
![密度演化](/the-well/MHD_256__density_normalized.gif)
...
**文档记录的求解器：** third-order hybrid ENO ideal-MHD solver
...
这是原生高分辨率发布版。官网与仓库均列出该目录，但当前常见 Hugging Face 流式列表中未包含；应使用官方下载 CLI/Flatiron 托管数据。
...
| 资源 | URL |
|---|---|
| 官方数据页 | <https://polymathic-ai.org/the_well/datasets/MHD_256/> |
| 仓库目录 | <https://github.com/PolymathicAI/the_well/tree/master/datasets/MHD_256> |
