---
title: "Euler 多象限 Riemann 问题——周期边界"
...
# Euler 多象限 Riemann 问题——周期边界

![密度演化（周期边界）](/the-well/euler_multi_quadrants_periodicBC__density_normalized.gif)


> **所属数据集：** The Well
> **数据目录：** `euler_multi_quadrants_periodicBC`
> **方程族：** 可压缩无黏 Euler 方程
...
|---|---|
| 所属集合 | The Well |
| 下载目录 | `euler_multi_quadrants_periodicBC` |
| 空间维数 | 2D |
| 坐标系 | Cartesian $(x,y)$ |
| 空间分辨率 | $512\times512$ |
| 每条轨迹存储帧数 | 100 |
...
| 资源 | URL |
|---|---|
| 官方数据页 | <https://polymathic-ai.org/the_well/datasets/euler_multi_quadrants_periodicBC/> |
| 仓库目录 | <https://github.com/PolymathicAI/the_well/tree/master/datasets/euler_multi_quadrants_periodicBC> |
