---
title: "Magnetohydrodynamic Turbulence — $256^3$"
...
official_page: "https://polymathic-ai.org/the_well/datasets/MHD_256/"
repository_directory: "https://github.com/PolymathicAI/the_well/tree/master/datasets/MHD_256"
huggingface_dataset: ""
...
# Magnetohydrodynamic Turbulence — $256^3$

![Density evolution](/the-well/MHD_256__density_normalized.gif)
...
| Estimated release size | 4.58 TB |
...
**Documented solver:** third-order hybrid ENO ideal-MHD solver
...
This is the native high-resolution release. It is listed by the official site and repository but is not currently among the commonly streamed Hugging Face entries; use the official download CLI/Flatiron-hosted data.
...
```bash
the-well-download --base-path ./the_well_data --dataset MHD_256 --split train
```
...
for split in train valid test; do
  the-well-download --base-path ./the_well_data --dataset MHD_256 --split "$split"
done
```
...
| Resource | URL |
|---|---|
| Official dataset page | <https://polymathic-ai.org/the_well/datasets/MHD_256/> |
| Repository directory | <https://github.com/PolymathicAI/the_well/tree/master/datasets/MHD_256> |
