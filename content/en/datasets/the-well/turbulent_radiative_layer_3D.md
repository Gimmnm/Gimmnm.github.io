---
title: "Turbulent Radiative Mixing Layer — 3D"
...
# Turbulent Radiative Mixing Layer — 3D

![Density evolution](/the-well/turbulent_radiative_layer_3D__density_normalized.gif)


> **Parent collection:** The Well
> **Directory:** `turbulent_radiative_layer_3D`
...
| Fixed in this release | Equation of state \(\gamma=5/3\), hot/cold phase setup and relative-flow convention, three-dimensional geometry, released resolution, 101 snapshots and the Athena++ solver configuration. |
...
| Spatial domain | 3D mixing-layer box |
| Estimated release size | 745 GB |
...
- full sequence: \((B,T,L_1,L_2,L_3,5)\);
- standard 4-frame history: \((B,4,L_1,L_2,L_3,5)\);
- standard 1-frame target: \((B,1,L_1,L_2,L_3,5)\).
...
This is the expensive 3D member of the dimension-transfer pair. The 90 trajectories mirror the 2D parameter design, but the simulations are independent dimensional realizations rather than exact frame-wise pairs.
...
| Resource | URL |
|---|---|
| Official dataset page | <https://polymathic-ai.org/the_well/datasets/turbulent_radiative_layer_3D/> |
| Repository directory | <https://github.com/PolymathicAI/the_well/tree/master/datasets/turbulent_radiative_layer_3D> |
| Hugging Face dataset | <https://huggingface.co/datasets/polymathic-ai/turbulent_radiative_layer_3D> |
