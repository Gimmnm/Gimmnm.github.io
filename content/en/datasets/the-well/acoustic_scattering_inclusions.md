---
title: "Acoustic Scattering — Inclusions"
...
Same pressure-ring family as the single-discontinuity release: 1–4 rings, amplitude \(\mathcal U(0.5,2)\), radius \(\mathcal U(0.06,0.15)\), zero initial velocity.
...
|---|---|
| Parent collection | The Well |
| Download directory | `acoustic_scattering_inclusions` |
...
| Estimated release size | 283.8 GB |
...
The current release notes report replacement of a corrupted trajectory in the acoustic-inclusions data. As with the discontinuity page, interpret the third acoustic equation with \(\partial_y p\). Current page metadata reports 101 snapshots.
...
| Resource | URL |
|---|---|
| Official dataset page | <https://polymathic-ai.org/the_well/datasets/acoustic_scattering_inclusions/> |
| Repository directory | <https://github.com/PolymathicAI/the_well/tree/master/datasets/acoustic_scattering_inclusions> |
| Hugging Face dataset | <https://huggingface.co/datasets/polymathic-ai/acoustic_scattering_inclusions> |
