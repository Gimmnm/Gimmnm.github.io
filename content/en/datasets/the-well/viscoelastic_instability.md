---
title: "Viscoelastic Instability — Legacy Processing"
...
official_page: "https://polymathic-ai.org/the_well/datasets/viscoelastic_instability/"
repository_directory: "https://github.com/PolymathicAI/the_well/tree/master/datasets/viscoelastic_instability"
huggingface_dataset: "https://huggingface.co/datasets/polymathic-ai/viscoelastic_instability"
paper: "https://arxiv.org/abs/2412.00568"
status: deprecated
repository_release_checked: "v1.2.0 / master"
last_verified: 2026-07-21
linkTitle: viscoelastic_instability
weight: 230
draft: false
ShowToc: true
TocOpen: true
...
# Viscoelastic Instability — Legacy Processing

> **Parent collection:** The Well  
> **Directory:** `viscoelastic_instability`  
...
|---|---|
| Parent collection | The Well |
| Download directory | `viscoelastic_instability` |
...
**Documented solver:** Dedalus direct numerical simulation of FENE-P channel flow
...
Deprecated: processing errors introduced duplicate/looping frames. It remains available only for backward comparison. The category totals in older text do not always add exactly to the 260 metadata trajectories.

Current repository status: **deprecated**. This document was checked against the repository state/release information available on 2026-07-21. Always inspect `dataset_name.yaml`, `stats.yaml`, HDF5 coordinates and release notes for the exact files used in an experiment.
...
```bash
the-well-download --base-path ./the_well_data --dataset viscoelastic_instability --split train
```
...
for split in train valid test; do
  the-well-download --base-path ./the_well_data --dataset viscoelastic_instability --split "$split"
done
```
...
| Resource | URL |
|---|---|
| Official dataset page | <https://polymathic-ai.org/the_well/datasets/viscoelastic_instability/> |
| Repository directory | <https://github.com/PolymathicAI/the_well/tree/master/datasets/viscoelastic_instability> |
| Hugging Face dataset | <https://huggingface.co/datasets/polymathic-ai/viscoelastic_instability> |
