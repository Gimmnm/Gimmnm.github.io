---
title: "Supernova Explosion — $64^3$"
...
official_page: "https://polymathic-ai.org/the_well/datasets/supernova_explosion_64/"
repository_directory: "https://github.com/PolymathicAI/the_well/tree/master/datasets/supernova_explosion_64"
huggingface_dataset: "https://huggingface.co/datasets/polymathic-ai/supernova_explosion_64"
paper: "https://arxiv.org/abs/2412.00568"
status: active
repository_release_checked: "v1.2.0 / master"
last_verified: 2026-07-21
linkTitle: supernova_explosion_64
weight: 190
draft: false
ShowToc: true
TocOpen: true
...
# Supernova Explosion — $64^3$

> **Parent collection:** The Well  
> **Directory:** `supernova_explosion_64`  
...
|---|---|
| Parent collection | The Well |
| Download directory | `supernova_explosion_64` |
...
| Estimated release size | 268.2 GB |
...
The two resolutions together contain 1000 trajectories, but counts are 740 versus 260; do not assume every low-resolution trajectory has a high-resolution counterpart.
...
```bash
the-well-download --base-path ./the_well_data --dataset supernova_explosion_64 --split train
```
...
for split in train valid test; do
  the-well-download --base-path ./the_well_data --dataset supernova_explosion_64 --split "$split"
done
```
...
| Resource | URL |
|---|---|
| Official dataset page | <https://polymathic-ai.org/the_well/datasets/supernova_explosion_64/> |
| Repository directory | <https://github.com/PolymathicAI/the_well/tree/master/datasets/supernova_explosion_64> |
| Hugging Face dataset | <https://huggingface.co/datasets/polymathic-ai/supernova_explosion_64> |
...
Recommended citations: Hirashima et al. supernova-surrogate papers and ASURA-FDPS/DISPH references listed by The Well.
